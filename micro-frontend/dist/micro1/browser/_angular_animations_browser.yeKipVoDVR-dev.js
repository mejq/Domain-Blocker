import { AUTO_STYLE, AnimationGroupPlayer, AnimationMetadataType, NoopAnimationPlayer, sequence, style, ɵPRE_STYLE } from "@nf-internal/chunk-HZT4A4RJ";
import { __objRest, __spreadValues } from "@nf-internal/chunk-WDMUDEB6";
...
function invalidTimingValue(exp) {
    return new _RuntimeError(3e3, ngDevMode && `The provided timing value "${exp}" is invalid.`);
}
