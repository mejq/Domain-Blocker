...
export function resolve(specifier, context, defaultResolve) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const importMap = yield importMapPromise;
        const importMapUrl = resolveSpecifier(importMap, specifier, parentURL);
        return defaultResolve(importMapUrl !== null && importMapUrl !== void 0 ? importMapUrl : specifier, context, defaultResolve);
    });
}
...
function getImportMapPromise() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let str;
        try {
            str = yield fs.readFile(importMapPath);
        }
        catch (err) {
            return emptyMap();
        }
...
//# sourceMappingURL=import-map-loader.js.map