import { Attribute, EventContract, EventContractContainer, EventDispatcher, EventPhase, clearAppScopedEarlyEventContract, getAppScopedQueuedEventInfos, isCaptureEventType, isEarlyEventType, registerDispatcher$1 } from "./chunk-BB632L5H.js";
import { REACTIVE_NODE, SIGNAL, SIGNAL_NODE, consumerAfterComputation, consumerBeforeComputation, consumerDestroy, consumerPollProducersForChange, createComputed, createLinkedSignal, createSignal, getActiveConsumer, isInNotificationPhase, linkedSignalSetFn, linkedSignalUpdateFn, producerAccessed, setActiveConsumer, setAlternateWeakRefImpl, setThrowInvalidWriteToSignalError, signalSetFn, signalUpdateFn, untracked } from "./chunk-PRKJF5HP.js";
import { NOT_FOUND, getCurrentInjector, setCurrentInjector } from "./chunk-WNSIDLSC.js";
import { __async, __spreadProps, __spreadValues } from "./chunk-WDMUDEB6.js";

// node_modules/@angular/core/fesm2022/core.mjs
import { setActiveConsumer as setActiveConsumer2, createWatch } from "@angular/core/primitives/signals";
import { NOT_FOUND as NOT_FOUND$2 } from "@angular/core/primitives/di";
import { BehaviorSubject, Subject, Subscription } from "rxjs";
import { map } from "rxjs/operators";
if (typeof globalThis.ngServerMode === "undefined") globalThis.ngServerMode = typeof window === "undefined" ? true : false;
...
var INJECTOR$1 = new InjectionToken(ngDevMode ? "INJECTOR" : "",
...
function afterRender(callbackOrSpec, options) {
  ...
  return afterRenderImpl(callbackOrSpec, injector, options, /* once */
  false);
}
...
function createBlockSummary(blockInfo) {
  return {
    ...
    hydrate: {
      ...
      viewport: hasHydrateTrigger(blockInfo, 2
...
function ɵɵdeferOnViewport(triggerIndex, walkUpTimes) {
  ...
  renderPlaceholder(lView, tNode);
  if (!(typeof ngServerMode !== "undefined" && ngServerMode)) {
    registerDomTrigger(lView, tNode, triggerIndex, walkUpTimes, onViewport, () => triggerDeferBlock(0, lView, tNode), 0
    /* TriggerType.Regular */);
  }
}
