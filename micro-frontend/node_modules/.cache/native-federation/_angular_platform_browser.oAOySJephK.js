import { a as j, b as L, c as U, d as k, e as P, f as z, g as x, h as B, i as Z } from "@nf-internal/chunk-AFCVOAPL";
import { a as E, b as H, c as w, d as O, e as N, f as A } from "@nf-internal/chunk-UAAASZNS";
import "@nf-internal/chunk-4CLCTAJ7";
import { ɵgetDOM as M, DOCUMENT as h } from "@angular/common";
import { ɵgetDOM as Ze } from "@angular/common";
import * as o from "@angular/core";
import { ɵglobal as S, ApplicationRef as $, InjectionToken as D, Injector as G, Optional as V, ɵConsole as ge, ɵRuntimeError as g, SecurityContext as d, ɵallowSanitizationBypassAndThrow as p, ɵunwrapSafeValue as f, ɵ_sanitizeUrl as Y, ɵ_sanitizeHtml as F, ɵbypassSanitizationTrustHtml as J, ɵbypassSanitizationTrustStyle as q, ɵbypassSanitizationTrustScript as X, ɵbypassSanitizationTrustUrl as K, ɵbypassSanitizationTrustResourceUrl as Q, makeEnvironmentProviders as W, ɵwithDomHydration as ee, ɵwithEventReplay as te, ɵwithI18nSupport as ne, ɵwithIncrementalHydration as re, ENVIRONMENT_INITIALIZER as Ee, inject as we, NgZone as Se, ɵZONELESS_ENABLED as Te, ɵformatRuntimeError as Me, Version as oe } from "@angular/core";
...
function C(t, i) { if (typeof COMPILED > "u" || !COMPILED) {
    let e = S.ng = S.ng || {};
    e[t] = i;
} }
var y = class {
    ...
    appRef;
    constructor(i) { this.appRef = i.injector.get($); }
    timeChangeDetection(i) { let e = i && i.record, n = "Change Detection"; e && "profile" in console && typeof console.profile == "function" && console.profile(n); let r = performance.now(), s = 0; for (; s < 5 || performance.now() - r < 500;)
        this.appRef.tick(), s++; let c = performance.now(); e && "profileEnd" in console && typeof console.profileEnd == "function" && console.profileEnd(n); let a = (c - r) / s; return console.log(`ran ${s} change detection cycles`), console.log(`${a.toFixed(2)} ms per check`), new y(a, s); }
}, R = "profiler";
function Ie(t) { return C(R, new _(t)), t; }
function He() { C(R, null); }
var T = class {
    static all() { return () => !0; }
...
var ae = { pan: !0, panstart: !0, panmove: !0, panend: !0, pancancel: !0, panleft: !0, panright: !0, panup: !0, pandown: !0, pinch: !0, pinchstart: !0, pinchmove: !0, pinchend: !0, pinchcancel: !0, pinchin: !0, pinchout: !0, press: !0, pressup: !0, rotate: !0, rotatestart: !0, rotatemove: !0, rotateend: !0, rotatecancel: !0, swipe: !0, swipeleft: !0, swiperight: !0, swipeup: !0, swipedown: !0, tap: !0, doubletap: !0 }, v = new D(""), I = new D(""), ce = (() => { class t {
    events = [];
    overrides = {};
    options;
    ...
    static ɵfac = function (n) { return new (n || t)(o.ɵɵinject(h), o.ɵɵinject(v), o.ɵɵinject(o.Injector), o.ɵɵinject(I, 8)); };
    static ɵprov = o.ɵɵdefineInjectable({ token: t, factory: t.ɵfac });
} return t; })(), Oe = (() => { class t {
    static ɵfac = function (n) { return new (n || t); };
    static ɵmod = o.ɵɵdefineNgModule({ type: t });
    static ɵinj = o.ɵɵdefineInjector({ providers: [{ provide: E, useClass: ue, multi: !0, deps: [h, v, G, [new V, I]] }, { provide: v, useClass: ce }] });
} return t; })(), de = (() => { class t {
    static ɵfac = function (n) { return new (n || t); };
    ...
    sanitize(e, n) { if (n == null)
        ...
        case d.HTML: return p(n, "HTML") ? f(n) : F(this._doc, String(n)).toString();
        case d.STYLE: return p(n, "Style") ? f(n) : n;
        case d.SCRIPT:
            if (p(n, "Script"))
                return f(n);
            throw new g(5200, !1);
        case d.URL: return p(n, "URL") ? f(n) : Y(String(n));
        case d.RESOURCE_URL:
            if (p(n, "ResourceURL"))
                return f(n);
            throw new g(5201, !1);
...
function Ae(t) { return m(u.HttpTransferCacheOptions, b(t)); }
function je() { return m(u.I18nSupport, ne()); }
function Le() { return m(u.EventReplay, te()); }
function Ue() { return m(u.IncrementalHydration, re()); }
function ke(...t) { let i = [], e = new Set; for (let { ɵproviders: r, ɵkind: s } of t)
    e.add(s), r.length && i.push(r); let n = e.has(u.HttpTransferCacheOptions); return W([[], ee(), e.has(u.NoHttpTransferCache) || n ? [] : b({}), i]); }
var Pe = new oe("19.2.14");
export { Z as BrowserModule, T as By, de as DomSanitizer, E as EVENT_MANAGER_PLUGINS, H as EventManager, w as EventManagerPlugin, v as HAMMER_GESTURE_CONFIG, I as HAMMER_LOADER, ce as HammerGestureConfig, Oe as HammerModule, u as HydrationFeatureKind, Ce as Meta, N as REMOVE_STYLES_ON_COMPONENT_DESTROY, Re as Title, Pe as VERSION, P as bootstrapApplication, z as createApplication, He as disableDebugTools, Ie as enableDebugTools, B as platformBrowser, ke as provideClientHydration, x as provideProtractorTestingSupport, Le as withEventReplay, Ae as withHttpTransferCacheOptions, je as withI18nSupport, Ue as withIncrementalHydration, Ne as withNoHttpTransferCache, j as ɵBrowserDomAdapter, L as ɵBrowserGetTestability, U as ɵDomEventsPlugin, A as ɵDomRendererFactory2, le as ɵDomSanitizerImpl, ue as ɵHammerGesturesPlugin, k as ɵKeyEventsPlugin, O as ɵSharedStylesHost, Ze as ɵgetDOM }; /*! Bundled license information:
