...
import { ɵisPromise as _isPromise, ɵRuntimeError as _RuntimeError, Injectable, ɵisNgModule as _isNgModule, isStandalone, createEnvironmentInjector, InjectionToken, EventEmitter, input, inject, ViewContainerRef, ChangeDetectorRef, Output, Input, Directive, reflectComponentType, Component, ɵisInjectable as _isInjectable, runInInjectionContext, NgModuleFactory, Compiler, NgZone, afterNextRender, EnvironmentInjector as EnvironmentInjector2, DestroyRef, ɵConsole as _Console, ɵPendingTasksInternal as _PendingTasksInternal } from "@angular/core";
...
function validateNode(route, fullPath, requireStandaloneComponents) {
    ...
    `);
        ...
        if (route.redirectTo && route.canActivate) {
            throw new _RuntimeError(4014, `Invalid configuration of route '${fullPath}': redirectTo and canActivate cannot be used together. Redirects happen before activation so canActivate will never be executed.`);
        }
...
import { LOCATION_INITIALIZED, HashLocationStrategy, LocationStrategy as LocationStrategy2, ViewportScroller as ViewportScroller2, Location as Location2, PathLocationStrategy } from "@angular/common";
import * as i02 from "@angular/core";
import { ɵRuntimeError as _RuntimeError2, ɵɵsanitizeUrlOrResourceUrl as __sanitizeUrlOrResourceUrl, booleanAttribute, HostListener, Input as Input2, HostBinding, Attribute, Directive as Directive2, EventEmitter as EventEmitter2, Output as Output2, ContentChildren, Optional, createEnvironmentInjector as createEnvironmentInjector2, Injectable as Injectable2, InjectionToken as InjectionToken2, ɵperformanceMarkFeature as _performanceMarkFeature, makeEnvironmentProviders, APP_BOOTSTRAP_LISTENER, ENVIRONMENT_INITIALIZER, provideAppInitializer, inject as inject2, Injector, ApplicationRef, InjectFlags, NgZone as NgZone3, SkipSelf, NgModule } from "@angular/core";
...
var RouterLink = class _RouterLink {
    ...
    static ɵdir = /* @__PURE__ */ i02.ɵɵdefineDirective({
        ...
        hostBindings: function RouterLink_HostBindings(rf, ctx) {
            ...
            if (rf & 2) {
                i02.ɵɵattribute("target", ctx.target);
            }
        },
        inputs: {
            target: "target",
