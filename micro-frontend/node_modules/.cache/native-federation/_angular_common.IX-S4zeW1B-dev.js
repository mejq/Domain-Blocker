import { DOCUMENT, PLATFORM_BROWSER_ID, PLATFORM_SERVER_ID, XhrFactory, isPlatformBrowser, isPlatformServer, parseCookieValue } from "@nf-internal/chunk-2HB24CSA";
...
import { Optional as Optional2, Inject as Inject2, Injectable as Injectable2, ɵgetLocalePluralCase as _getLocalePluralCase, ɵfindLocaleData as _findLocaleData, ɵLocaleDataIndex as _LocaleDataIndex, ɵgetLocaleCurrencyCode as _getLocaleCurrencyCode, LOCALE_ID, ɵstringify as _stringify, Input, Directive, createNgModule, NgModuleRef, ɵRuntimeError as _RuntimeError, Host, Attribute, RendererStyleFlags2, ɵisPromise as _isPromise, ɵisSubscribable as _isSubscribable, untracked, Pipe, InjectionToken as InjectionToken2, DEFAULT_CURRENCY_CODE, NgModule } from "@angular/core";
...
import { ɵregisterLocaleData as _registerLocaleData, Version, ɵɵdefineInjectable as __defineInjectable, inject as inject2, InjectionToken as InjectionToken3, ɵRuntimeError as _RuntimeError2, ɵformatRuntimeError as _formatRuntimeError, PLATFORM_ID, Injectable as Injectable4, ɵIMAGE_CONFIG as _IMAGE_CONFIG, Renderer2 as Renderer22, ElementRef as ElementRef2, Injector, DestroyRef, ɵperformanceMarkFeature as _performanceMarkFeature, NgZone, ApplicationRef, booleanAttribute, numberAttribute, ChangeDetectorRef as ChangeDetectorRef2, ɵIMAGE_CONFIG_DEFAULTS as _IMAGE_CONFIG_DEFAULTS, ɵunwrapSafeValue as _unwrapSafeValue, Input as Input2, Directive as Directive2 } from "@angular/core";
import { ɵIMAGE_CONFIG } from "@angular/core";
...
var LCPImageObserver = class _LCPImageObserver {
    ...
    observer = null;
    constructor() {
        const isBrowser = isPlatformBrowser(inject2(PLATFORM_ID));
        assertDevMode("LCP checker");
        const win = inject2(DOCUMENT).defaultView;
...
var NgOptimizedImage = class _NgOptimizedImage {
    ...
    config = processConfig(inject2(_IMAGE_CONFIG));
    renderer = inject2(Renderer22);
    imgElement = inject2(ElementRef2).nativeElement;
