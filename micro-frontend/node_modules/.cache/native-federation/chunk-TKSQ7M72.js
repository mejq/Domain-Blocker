...
var intervalProvider = {
    setInterval: function (handler, timeout2) {
        ...
        if (delegate === null || delegate === void 0 ? void 0 : delegate.setInterval) {
            return delegate.setInterval.apply(delegate, __spreadArray3([handler, timeout2], __read3(args)));
        }
        return setInterval.apply(void 0, __spreadArray3([handler, timeout2], __read3(args)));
    },
...
import { __read as __read4, __spreadArray as __spreadArray4 } from "tslib";
var isArray2 = Array.isArray;
function callOrApply(fn, args) {
    return isArray2(args) ? fn.apply(void 0, __spreadArray4([], __read4(args))) : fn(args);
}
...
import { __read as __read5, __spreadArray as __spreadArray5 } from "tslib";
function zip() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
...
import { __values as __values4 } from "tslib";
function bufferCount(bufferSize, startBufferEvery) {
    ...
    return operate(function (source, subscriber) {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            ...
            if (toEmit) {
                try {
                    for (var toEmit_1 = __values4(toEmit), toEmit_1_1 = toEmit_1.next(); !toEmit_1_1.done; toEmit_1_1 = toEmit_1.next()) {
...
import { __values as __values5 } from "tslib";
function bufferTime(bufferTimeSpan) {
    ...
    return operate(function (source, subscriber) {
        ...
        var bufferTimeSubscriber = createOperatorSubscriber(subscriber, function (value) {
            ...
            try {
                for (var recordsCopy_1 = __values5(recordsCopy), recordsCopy_1_1 = recordsCopy_1.next(); !recordsCopy_1_1.done; recordsCopy_1_1 = recordsCopy_1.next()) {
...
import { __values as __values6 } from "tslib";
function bufferToggle(openings, closingSelector) {
    return operate(function (source, subscriber) {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            var e_1, _a;
            try {
                for (var buffers_1 = __values6(buffers), buffers_1_1 = buffers_1.next(); !buffers_1_1.done; buffers_1_1 = buffers_1.next()) {
                    var buffer2 = buffers_1_1.value;
                    buffer2.push(value);
                }
            }
...
import { __read as __read6, __spreadArray as __spreadArray6 } from "tslib";
function combineLatest2() {
    ...
    var resultSelector = popResultSelector(args);
    return resultSelector ? pipe(combineLatest2.apply(void 0, __spreadArray6([], __read6(args))), mapOneOrManyArgs(resultSelector)) : operate(function (source, subscriber) {
        combineLatestInit(__spreadArray6([source], __read6(argsOrArgArray(args))))(subscriber);
    });
}
// node_modules/rxjs/dist/esm5/internal/operators/combineLatestWith.js
import { __read as __read7, __spreadArray as __spreadArray7 } from "tslib";
function combineLatestWith() {
    var otherSources = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        otherSources[_i] = arguments[_i];
    }
    return combineLatest2.apply(void 0, __spreadArray7([], __read7(otherSources)));
}
...
import { __read as __read8, __spreadArray as __spreadArray8 } from "tslib";
function concat2() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    ...
    var scheduler = popScheduler(args);
    return operate(function (source, subscriber) {
        concatAll()(from(__spreadArray8([source], __read8(args)), scheduler)).subscribe(subscriber);
    });
}
// node_modules/rxjs/dist/esm5/internal/operators/concatWith.js
import { __read as __read9, __spreadArray as __spreadArray9 } from "tslib";
function concatWith() {
    var otherSources = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        otherSources[_i] = arguments[_i];
    }
    return concat2.apply(void 0, __spreadArray9([], __read9(otherSources)));
}
...
import { __read as __read10, __spreadArray as __spreadArray10 } from "tslib";
function endWith() {
    var values = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    return function (source) {
        return concat(source, of.apply(void 0, __spreadArray10([], __read10(values))));
    };
}
...
import { __values as __values7 } from "tslib";
function takeLast(count2) {
    return count2 <= 0 ? function () {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            ...
            var e_1, _a;
            try {
                for (var buffer_1 = __values7(buffer2), buffer_1_1 = buffer_1.next(); !buffer_1_1.done; buffer_1_1 = buffer_1.next()) {
...
import { __read as __read11, __spreadArray as __spreadArray11 } from "tslib";
function merge() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    ...
    return operate(function (source, subscriber) {
        mergeAll(concurrent)(from(__spreadArray11([source], __read11(args)), scheduler)).subscribe(subscriber);
    });
}
// node_modules/rxjs/dist/esm5/internal/operators/mergeWith.js
import { __read as __read12, __spreadArray as __spreadArray12 } from "tslib";
function mergeWith() {
    var otherSources = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        otherSources[_i] = arguments[_i];
    }
    return merge.apply(void 0, __spreadArray12([], __read12(otherSources)));
}
...
import { __read as __read13, __spreadArray as __spreadArray13 } from "tslib";
function onErrorResumeNextWith() {
    ...
    var nextSources = argsOrArgArray(sources);
    return function (source) {
        return onErrorResumeNext.apply(void 0, __spreadArray13([source], __read13(nextSources)));
    };
}
...
import { __read as __read14, __spreadArray as __spreadArray14 } from "tslib";
function raceWith() {
    var otherSources = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        otherSources[_i] = arguments[_i];
    ...
    return !otherSources.length ? identity : operate(function (source, subscriber) {
        raceInit(__spreadArray14([source], __read14(otherSources)))(subscriber);
    });
}
...
import { __read as __read15, __spreadArray as __spreadArray15 } from "tslib";
...
function handleReset(reset, on) {
    ...
    return innerFrom(on.apply(void 0, __spreadArray15([], __read15(args)))).subscribe(onSubscriber);
}
...
import { __values as __values8 } from "tslib";
function windowCount(windowSize, startWindowEvery) {
    ...
    return operate(function (source, subscriber) {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            var e_1, _a;
            try {
                for (var windows_1 = __values8(windows), windows_1_1 = windows_1.next(); !windows_1_1.done; windows_1_1 = windows_1.next()) {
...
import { __values as __values9 } from "tslib";
function windowToggle(openings, closingSelector) {
    return operate(function (source, subscriber) {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            ...
            try {
                for (var windowsCopy_1 = __values9(windowsCopy), windowsCopy_1_1 = windowsCopy_1.next(); !windowsCopy_1_1.done; windowsCopy_1_1 = windowsCopy_1.next()) {
...
import { __read as __read16, __spreadArray as __spreadArray16 } from "tslib";
function withLatestFrom() {
    ...
    return operate(function (source, subscriber) {
        ...
        source.subscribe(createOperatorSubscriber(subscriber, function (value) {
            if (ready) {
                var values = __spreadArray16([value], __read16(otherValues));
                subscriber.next(project ? project.apply(void 0, __spreadArray16([], __read16(values))) : values);
            }
        }));
    });
}
...
import { __read as __read17, __spreadArray as __spreadArray17 } from "tslib";
function zip2() {
    var sources = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        sources[_i] = arguments[_i];
    ...
    return operate(function (source, subscriber) {
        zip.apply(void 0, __spreadArray17([source], __read17(sources))).subscribe(subscriber);
    });
}
// node_modules/rxjs/dist/esm5/internal/operators/zipWith.js
import { __read as __read18, __spreadArray as __spreadArray18 } from "tslib";
function zipWith() {
    var otherInputs = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        otherInputs[_i] = arguments[_i];
    }
    return zip2.apply(void 0, __spreadArray18([], __read18(otherInputs)));
}
